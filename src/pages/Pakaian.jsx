...
const Pakaian = ({ addToCart }) => {
  ...
  let filteredProducts = clothes.filter((product) =>
  ...
  return (
    <div className="bg-gray-100">
      <div className="flex justify-between items-center mb-4 mt-0 px-4 flex-wrap">
        <h2 className="text-2xl font-bold w-full sm:w-auto mt-3">Pakaian Product</h2>
            ...
            <div key={product.id} className="bg-white p-4 shadow rounded">
              <div className="flex flex-col h-full">
                ...
                <div className="mt-4 flex justify-between">
                  <Link
                    to={`/pakaian/${product.id}`} // Mengarahkan ke halaman detail produk
